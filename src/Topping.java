...
public class Topping 
{
	...
	public Topping(int topID, String topName, double perAMT, double medAMT, double lgAMT, double xLAMT,
			double custPrice, double busPrice, int minINVT, int curINVT, String pizzaSize) {
		TopID = topID;
		TopName = topName;
		PerAMT = perAMT;
		MedAMT = medAMT;
		LgAMT = lgAMT;
		XLAMT = xLAMT;
		double multiply = perAMT;
		if( pizzaSize == "medium") multiply = medAMT;
		else if (pizzaSize == "large") multiply = lgAMT;
		else  multiply = xLAMT;
		CustPrice = custPrice;
		BusPrice = busPrice*multiply;
		MinINVT = minINVT;
		CurINVT = curINVT;
	}
	public Topping(int topID, String topName, double perAMT, double medAMT, double lgAMT, double xLAMT,
	...
	public void setIsDouble(int d){
		isDouble = d;
	}
	public int getIsDouble(){return isDouble;}
